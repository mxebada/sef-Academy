...
import { AddCourse, SortCourses } from "../../Redux/reducer/Courses";
import { useNavigate } from "react-router-dom";

function FormAddCourses() {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            dispatch(AddCourse({ ...values, Image: image, Status: status }))
