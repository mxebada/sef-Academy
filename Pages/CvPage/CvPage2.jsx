...
return (
    ...
    <form className="col-12 col-lg-4 me-lg-5" onSubmit={formik.handleSubmit}>
    ...
    <div className="col-12 col-lg-2 mb-3 mb-lg-0">
        <button type="submit" onClick={ () => (formik.handleSubmit(), Navigate('/CV/Form3'))} className="btn bg-gold text-white text-uppercase btn-gold-hover py-3 w-100">Continue</button>
    </div>
